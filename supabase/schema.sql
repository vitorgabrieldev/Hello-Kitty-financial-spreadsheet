-- ============================================================
-- Hello Kitty Finance — Supabase Schema
-- ============================================================
...
create index idx_transactions_user_card on transactions(user_id, card_id);
...
create table if not exists notifications (
  ...
  reference_id uuid,
  reference_type text check (reference_type in ('card', 'transaction', 'installment')),
...
-- ============================================================
-- TRIGGERS: auto-create profile after signup
-- ============================================================
